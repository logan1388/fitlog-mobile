...
export const fetchExercises = (workout) => {
  return (dispatch) => {
    ...
    axios
      .get(`${endpoint}/api/exercises/${workout}`)
      .then((res) => {
...
export const expandExercise = (workouts, category, name, userId) => {
  return (dispatch, getState) => {
    ...
    axios
      .post(endpoint + '/api/workoutlog/log', exercise)
      .then((res) => {
        var logs = res.data;
        logs.map((log) => {
...
export const addExerciseLog = (exerciseLog, logToBeUpdated, workouts) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/workoutlog/', exerciseLog)
      .then((res) => {
...
export const addTodayWorkout = (userId, category, date) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/workout/', workout)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => console.log(error));
...
export const addBestSets = (exerciseLog, workouts) => {
  return (dispatch) => {
    axios
      .post(endpoint + '/api/bestset/', exerciseLog)
      .then((res) => {
        dispatch(
          expandExercise(
            workouts,
...
export const bestSets = (userId, category, name) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/bestset/set', bestSetsRequest)
      .then((res) => {
        dispatch(
          fetchBestSetsSuccess(
            res.data.maxWeight,
            res.data.maxReps,
            res.data.bestSet,
          ),
...
export const maxReps = (userId, name) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/maxreps/reps', maxRepsRequest)
      .then((res) => {
...
export const maxTime = (userId, name) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/maxtime/time', maxTimeRequest)
      .then((res) => {
...
export const workoutHistory = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/workout/workoutHistory', param)
      .then((res) => {
...
export const workoutSummary = (userId) => {
  return (dispatch) => {
    let param = { userId: userId };
    axios
      .post(endpoint + '/api/workout/workoutSummary', param)
      .then((res) => {
...
export const activities = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/workoutlog/logs', param)
      .then((res) => {
        console.log(res);
...
export const saveNote = (id, category, note) => {
  return (dispatch) => {
    ...
    axios
      .put(endpoint + '/api/workoutlog/note', param)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => console.log(error));
...
export const awardsHistory = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/awards/', param)
      .then((res) => {
...
export const weeklyAwards = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/awards/week', param)
      .then((res) => {
...
export const weeklyLogs = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(endpoint + '/api/workoutlog/logsWeek', param)
      .then((res) => {
...
export const addMaxTime = (exerciseLog) => {
  return (dispatch) => {
    axios
      .post(endpoint + '/api/maxtime/', exerciseLog)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => console.log(error));
