...
const BestLog = props => {
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            {props.bestSet && <View style={styles.max}>
            ...
            {props.maxWt && <View style={styles.max}>
            ...
            {props.maxRps && <View style={styles.max}>
                <Text style={[styles.maxText, themeTextStyle]}>Max Reps</Text>
                <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                    <Text style={themeTextStyle}>{props.maxRps.weight ? props.maxRps.weight : ''} </Text>
                    <Text style={themeTextStyle}>{props.maxRps.weight ? props.maxRps.unit : ''} </Text>
                    <Text style={themeTextStyle}>{props.maxRps.count} reps</Text>
                </View>
            </View>}
            {props.maxTime && <View style={styles.max}>
